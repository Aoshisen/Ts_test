...
function advanceGetVal(obj, key) {
    return obj[key];
}
//调用advanceGetVal 
var obj1 = {
...
var objName = advanceGetVal(obj1, 'name');
//TODO: 泛型类
...
function getData(url) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, fetch(url).then(function (res) { return res.json(); }).then(function (data) { return data; })];
                case 1:
                    result = _a.sent();
